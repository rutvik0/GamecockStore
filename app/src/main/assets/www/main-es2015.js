...
const routes = [
    ...
    {
        path: 'add-product',
        loadChildren: () => Promise.all(/*! import() | add-product-add-product-module */[__webpack_require__.e("common"), __webpack_require__.e("add-product-add-product-module")]).then(__webpack_require__.bind(null, /*! ./add-product/add-product.module */ "./src/app/add-product/add-product.module.ts")).then(m => m.AddProductPageModule)
    },
    {
        path: 'cart',
    ...
    {
        path: 'order-detail',
        loadChildren: () => Promise.all(/*! import() | order-detail-order-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("order-detail-order-detail-module")]).then(__webpack_require__.bind(null, /*! ./order-detail/order-detail.module */ "./src/app/order-detail/order-detail.module.ts")).then(m => m.OrderDetailPageModule)
    },
    {
        path: 'order-list',
        loadChildren: () => Promise.all(/*! import() | order-list-order-list-module */[__webpack_require__.e("common"), __webpack_require__.e("order-list-order-list-module")]).then(__webpack_require__.bind(null, /*! ./order-list/order-list.module */ "./src/app/order-list/order-list.module.ts")).then(m => m.OrderListPageModule)
    },
    {
        path: 'product-detail',
        loadChildren: () => Promise.all(/*! import() | product-detail-product-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("product-detail-product-detail-module")]).then(__webpack_require__.bind(null, /*! ./product-detail/product-detail.module */ "./src/app/product-detail/product-detail.module.ts")).then(m => m.ProductDetailPageModule)
    },
    {
        path: 'product-list',
        loadChildren: () => Promise.all(/*! import() | product-list-product-list-module */[__webpack_require__.e("common"), __webpack_require__.e("product-list-product-list-module")]).then(__webpack_require__.bind(null, /*! ./product-list/product-list.module */ "./src/app/product-list/product-list.module.ts")).then(m => m.ProductListPageModule)
    },
    {
        path: 'signup',
    ...
    {
        path: 'update-product',
        loadChildren: () => Promise.all(/*! import() | update-product-update-product-module */[__webpack_require__.e("common"), __webpack_require__.e("update-product-update-product-module")]).then(__webpack_require__.bind(null, /*! ./update-product/update-product.module */ "./src/app/update-product/update-product.module.ts")).then(m => m.UpdateProductPageModule)
    }
];
...
const firebaseConfig = {
    apiKey: "AIzaSyCe_0rwWx0St8MgW4B58TbOAOyGiSAw6jw",
    authDomain: "gamecockstore-c97ab.firebaseapp.com",
    databaseURL: "https://gamecockstore-c97ab.firebaseio.com",
    projectId: "gamecockstore-c97ab",
    storageBucket: "gamecockstore-c97ab.appspot.com",
    messagingSenderId: "319457678439",
    appId: "1:319457678439:web:bd61e6239edd071b1270c2",
    measurementId: "G-85MDCG0MWJ"
};
...
module.exports = __webpack_require__(/*! /home/rutvikpatel/gamecock-store/src/main.ts */"./src/main.ts");
